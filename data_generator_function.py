...
'''Simplified Data Generation Function without the generate_spend_from_demand function, and without control variables. 
The variation of media spend by channels is now controlled in the spend_scalar argument with random noise added. '''
